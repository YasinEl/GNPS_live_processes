...
if __name__ == '__main__':
    ...
    def normalize_to_first_mzml(group):
        ...
        for variable in ['rt_bin_0',  'rt_bin_1',  'rt_bin_2',  'int_bin_0',  'int_bin_1',  'int_bin_2']:
    ...
    df_untargeted_injection_stability = df_untargeted_injection_stability.groupby('qctype').apply(normalize_to_first_mzml).reset_index(drop=True)




    print(df_untargeted_injection_stability)
