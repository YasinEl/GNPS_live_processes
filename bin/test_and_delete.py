...
def purity_without_isotopes(isolated_mzs, feature_isotopes, isolated_ints, is_within_ppm, ppm, precursor_int):
    ...
    print(new_isolated_mzs)
    print(new_isolated_ints)
    print(precursor_int)
...
file_path = "/home/yasin/yasin/projects/GNPS_live_processes/random_data/onr2.mzML"
featureXML_path = '/home/yasin/yasin/projects/GNPS_live_processes/work/72/5356b28b6551d2aa3323cdd2edf778/feature_adducts.featureXML'
ppm_tr = 20
