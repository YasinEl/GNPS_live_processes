...
for mzml_file in "$input_dir"/*.mzML; do
    ...
    nextflow run nf_workflow.nf --mzml_files "$mzml_file" --parameter_file /home/yasin/yasin/projects/GNPS_live_processes/ipsita_carryOverDataset/demo_parameters_carryOver.xlsx
